...
void CDlgWifi::OnSavewifiparam() 
{
	...
	{
		if (m_uKeyLen < 8||m_uKeyLen > 63)
		{
			AfxMessageBox("Character length should be 8~63");
			return;
		}
		...
		memcpy(m_WifiCfg.struWifiCfg.key.wpa_psk.sKeyInfo,m_strEncKey,WIFI_WPA_PSK_MAX_KEY_LENGTH);
