...
public:
    ...
    NET_DVR_ALARMHOST_OTHER_STATUS  m_struAlarmOtherStatus;
...
public :
    ...
    BOOL GetAlarmHostOtherStatus(NET_DVR_ALARMHOST_OTHER_STATUS& struAlarmOtherStatus);

    void SetAlarmHostMainStatusToWnd(NET_DVR_ALARMHOST_MAIN_STATUS_V40& struAlarmMainStatus);
    void SetAlarmHostOtherStatusToWnd(NET_DVR_ALARMHOST_OTHER_STATUS& struAlarmOtherStatus);
