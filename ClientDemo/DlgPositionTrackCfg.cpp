...
void CDlgPositionTrackCfg::OnBtnSetPositionTrack() 
{
    ...
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_FAIL_T, "NET_DVR_SET_POSITION_TRACK");
        AfxMessageBox("fail to set position track");
    }
    else
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_SET_POSITION_TRACK");
...
BOOL CDlgPositionTrackCfg::OnInitDialog() 
{
	...
	{
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_FAIL_T, "NET_DVR_GET_POSITION_TRACK");
        AfxMessageBox("Fail to get position track");
        return FALSE;
	}
    else
    {
        g_pMainDlg->AddLog(m_iDevIndex, OPERATION_SUCC_T, "NET_DVR_GET_POSITION_TRACK");
    }
