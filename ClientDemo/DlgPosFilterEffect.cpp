...
void CALLBACK TestEffectPosDataCallBack(DWORD typeInfo,NET_DVR_NAKED_DATA_INFO *pStruNakedDataInfo, char *pInfo, DWORD dwInfoLen, void *pUser)
{
	...
	// 		return;
	// 	}
	::SendMessage(hWnd,MSG_PULL_TEST_EFFECT_RECEIVEDATA_SHOW,(DWORD)pStruNakedDataInfo, 0);
    ::SendMessage(hWnd,MSG_PULL_TEST_EFFECT_RECEIVEDATA_SHOW,(DWORD)pInfo,1);
}
