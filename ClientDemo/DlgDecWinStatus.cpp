// DlgDecWinStatus.cpp : implementation file
//
...
CDlgDecWinStatus::CDlgDecWinStatus(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgDecWinStatus::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgDecWinStatus)
	m_dwAFrameNum = 0;
	m_byAFrameRate = 0;
	m_wPicHeight = 0;
	m_wPicWidth = 0;
...
void CDlgDecWinStatus::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgDecWinStatus)
...
BEGIN_MESSAGE_MAP(CDlgDecWinStatus, CDialog)
	//{{AFX_MSG_MAP(CDlgDecWinStatus)
...
/////////////////////////////////////////////////////////////////////////////
// CDlgDecWinStatus message handlers

BOOL CDlgDecWinStatus::OnInitDialog() 
{
	...
	OnBtnUpdate();
	SetTimer(WALL_WINSTATUS_TIMER, 3000, NULL);
	return TRUE;  // return TRUE unless you set the focus to a control
	              // EXCEPTION: OCX Property Pages should return FALSE
}


void CDlgDecWinStatus::OnBtnUpdate() 
{
...
void CDlgDecWinStatus::ShowData()
{
...
void CDlgDecWinStatus::OnTimer(UINT_PTR nIDEvent)
#else
void CDlgDecWinStatus::OnTimer(UINT nIDEvent)
#endif
{
