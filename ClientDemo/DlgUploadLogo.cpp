...
void CDlgUploadLogo::OnBtnGetLogoOverlaycfg() 
{
	...
	DWORD dwReturn = 0;
	if (NET_DVR_GetDVRConfig(m_lServerID, NET_DVR_GET_LOGO_OVERLAYCFG, 1, &m_struLogoOverlay,
...
void CDlgUploadLogo::OnBtnSetLogoOverlaycfg() 
{
	...
	if (NET_DVR_SetDVRConfig(m_lServerID, NET_DVR_SET_LOGO_OVERLAYCFG, 1, &m_struLogoOverlay, sizeof(m_struLogoOverlay)))
	{
