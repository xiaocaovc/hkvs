...
BOOL CDlgOutputScheduleRuleCfg::GetOutputScheduleRuleCfg()
{
    ...
    if (!NET_DVR_GetDVRConfig(m_lUserID, NET_DVR_GET_OUTPUT_SCHEDULE_RULECFG,1,&m_struOutputRuleCfg, sizeof(m_struOutputRuleCfg),
		&dwReturn))
    {
        g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_GET_OUTPUT_SCHEDULE_RULECFG Chan[%d]", 1);
        bRet = FALSE;
    }
    else
    {
        g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_SUCC_T, "NET_DVR_GET_OUTPUT_SCHEDULE_RULECFG Chan[%d]", 1);
        bRet = TRUE;
    }
	return bRet;
}
...
BOOL CDlgOutputScheduleRuleCfg::SetOutputScheduleRuleCfg()
{
    ...
    if (!NET_DVR_SetDVRConfig(m_lUserID, NET_DVR_SET_OUTPUT_SCHEDULE_RULECFG,1,&m_struOutputRuleCfg, sizeof(m_struOutputRuleCfg)))
    {
        g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_SET_OUTPUT_SCHEDULE_RULECFG Chan[%d]", 1);
        bRet = FALSE;
    }
    else
    {
        g_pMainDlg->AddLog(m_iDeviceIndex, OPERATION_SUCC_T, "NET_DVR_SET_OUTPUT_SCHEDULE_RULECFG Chan[%d]", 1);
        bRet = TRUE;
    }
	return bRet;
}
...
{   
	const NET_DVR_ONE_OUTPUT_SCHEDULE_RULE& struOneRuleCfg = m_struOutputRuleCfg.struOutputRule[nRuleIndex];
...
void CDlgOutputScheduleRuleCfg::SaveWndRuleContent(int nRuleIndex)
{
	...
	NET_DVR_ONE_OUTPUT_SCHEDULE_RULE& struOneRuleCfg = m_struOutputRuleCfg.struOutputRule[nRuleIndex];
