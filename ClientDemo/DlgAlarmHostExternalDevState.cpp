...
void CDlgAlarmHostExternalDevState::SetUpsState() 
{
	...
	m_listState.InsertItem(index, "功率因素", 0);
	...
	if (1 == m_struUpsState.iBatteryTemperature)
	{
		g_StringLanType(m_sTemp, "正常", "Normal");
		sprintf(m_sTemp, "%s", m_sTemp);
	}
	else if(2 == m_struUpsState.iBatteryTemperature)
	{
