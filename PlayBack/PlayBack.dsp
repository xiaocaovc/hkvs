...
# ADD LINK32 HCNetSDK.lib PlayCtrl.lib ws2_32.lib DsSdk.lib winmm.lib /nologo /subsystem:windows /pdb:"bin/PlayBack.pdb" /machine:I386 /out:"bin/PlayBack.exe" /libpath:"../../../库文件"
...
# ADD LINK32 HCNetSDK.lib PlayCtrl.lib ws2_32.lib DsSdk.lib winmm.lib /nologo /subsystem:windows /pdb:"bin/PlayBack.pdb" /debug /machine:I386 /out:"bin/PlayBack.exe" /pdbtype:sept /libpath:"../../../库文件"
